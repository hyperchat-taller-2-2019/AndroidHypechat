...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private final String URL_LOGOUT = "https://secure-plateau-18239.herokuapp.com/logout/";
    ...
    private void logout() {
        ...
        String URL = URL_LOGOUT + Usuario.getInstancia().getToken();
                ...
                (Request.Method.GET, URL, requestBody, new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        switch (error.networkResponse.statusCode){
                            case (500):
                                Toast.makeText(HomeActivity.this,"No fue posible conectarse con el servidor, por favor intente mas tarde", Toast.LENGTH_LONG).show();
                                break;
                            case (400):
                                Toast.makeText(HomeActivity.this,"Token invalido.", Toast.LENGTH_LONG).show();
                                break;
                            case (404):
                                Toast.makeText(HomeActivity.this,"El usuario o organizacion es invalido", Toast.LENGTH_LONG).show();
                                break;
                        }
                    }
                });
        ...
        HttpConexionSingleton.getInstance(HomeActivity.this).addToRequestQueue(jsonObjectRequest);
